...
const { createUser, userSignIn, uploadProfile, signOut } = require('../controllers/controller') //São ações que seu servidor pode realizar, como criar um usuário ou fazer login.
